...
//---- Dataset: Cover Type [ https://archive.ics.uci.edu/ml/datasets/HIGGS ]
//---------------------------------------------------------------------------------------------------//
...
object HIGGSDatasetApp {
  ...
  def main (arg: Array[String]): Unit = {
    ...
    // Load Data
    var training = spark.read.option("header","true").option("inferSchema","true").format("csv").load("wasb:///example/data/HIGGS_training_data.csv")
    var testing  = spark.read.option("header","true").option("inferSchema","true").format("csv").load("wasb:///example/data/HIGGS_testing_data.csv")//("/home/eissa/mycode/data/testing_data.csv")
    print("Data Laoded " +  "\n")
